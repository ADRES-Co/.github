...
CREATE OR REPLACE TABLE muestra_dos_millon_suficiencia_2018 AS
...
--SELECT *
--FROM muestra_dos_millones_suficiencia_2018
--limit 10;
...
CREATE OR REPLACE TABLE tabla_muestra_dos_millon_suficiencia_2018
AS
SELECT
...
FROM muestra_dos_millon_suficiencia_2018
...
SELECT
  *
FROM
  tabla_muestra_dos_millon_suficiencia_2018

-- COMMAND ----------

-- muestra de 2.000.000 millones cédulas únicas año 2019
CREATE OR REPLACE TABLE muestra_dos_millon_suficiencia_2019 AS
SELECT DISTINCT NUM_ANO, STR_TIPO_ID, STR_IDENTIFICACION, STR_COD_EPS, DESC_EPS, STR_REGIMEN, STR_COD_ACTIVIDAD, NOMBRE_ACTIVIDAD, NUM_VALOR_TOTAL, NT_RULES, NT_DENOMINA, DESC_ACTIVIDAD
FROM (
  SELECT NUM_ANO, STR_TIPO_ID, STR_IDENTIFICACION, STR_COD_EPS, DESC_EPS, STR_REGIMEN, STR_COD_ACTIVIDAD,  NOMBRE_ACTIVIDAD, NUM_VALOR_TOTAL, NT_RULES, NT_DENOMINA, DESC_ACTIVIDAD, ROW_NUMBER() OVER (PARTITION BY STR_TIPO_ID, STR_IDENTIFICACION ORDER BY STR_TIPO_ID, STR_IDENTIFICACION) AS row_num
  FROM temp_suficiencia_unificado_dw
...
CREATE OR REPLACE TABLE tabla_muestra_dos_millon_suficiencia_2019
AS
SELECT
  TO_DATE(CAST(NUM_ANO AS STRING), 'yyyy') AS Year,
  STR_COD_EPS, 
  ...
  SUM(NUM_VALOR_TOTAL) AS Suma_total_valor,
  COUNT(NT_RULES) AS Frecuencia
FROM muestra_dos_millon_suficiencia_2019
GROUP BY TO_DATE(CAST(NUM_ANO AS STRING), 'yyyy'), STR_COD_EPS, 
  DESC_EPS, 
  STR_REGIMEN, 
  STR_COD_ACTIVIDAD,  
...
SELECT
  *
FROM
  tabla_muestra_dos_millon_suficiencia_2019

-- COMMAND ----------

-- muestra de 2.000.000 millomes cédulas únicas año 2020
CREATE OR REPLACE TABLE muestra_dos_millon_suficiencia_2020 AS
SELECT DISTINCT NUM_ANO, STR_TIPO_ID, STR_IDENTIFICACION, STR_COD_EPS, DESC_EPS, STR_REGIMEN, STR_COD_ACTIVIDAD, NOMBRE_ACTIVIDAD, NUM_VALOR_TOTAL, NT_RULES, NT_DENOMINA, DESC_ACTIVIDAD
FROM (
  SELECT NUM_ANO, STR_TIPO_ID, STR_IDENTIFICACION, STR_COD_EPS, DESC_EPS, STR_REGIMEN, STR_COD_ACTIVIDAD,  NOMBRE_ACTIVIDAD, NUM_VALOR_TOTAL, NT_RULES, NT_DENOMINA, DESC_ACTIVIDAD, ROW_NUMBER() OVER (PARTITION BY STR_TIPO_ID, STR_IDENTIFICACION ORDER BY STR_TIPO_ID, STR_IDENTIFICACION) AS row_num
  FROM temp_suficiencia_unificado_dw
...
CREATE OR REPLACE TABLE tabla_muestra_dos_millon_suficiencia_2020
AS
SELECT
  TO_DATE(CAST(NUM_ANO AS STRING), 'yyyy') AS Year,
  STR_COD_EPS, 
  ...
  SUM(NUM_VALOR_TOTAL) AS Suma_total_valor,
  COUNT(NT_RULES) AS Frecuencia
FROM muestra_dos_millon_suficiencia_2020
GROUP BY TO_DATE(CAST(NUM_ANO AS STRING), 'yyyy'), STR_COD_EPS, 
  DESC_EPS, 
  STR_REGIMEN, 
  STR_COD_ACTIVIDAD,  
...
SELECT
  *
FROM
  tabla_muestra_dos_millon_suficiencia_2020

-- COMMAND ----------

-- muestra de 2.000.000 millones cédulas únicas año 2021
CREATE OR REPLACE TABLE muestra_dos_millon_suficiencia_2021 AS
SELECT DISTINCT NUM_ANO, STR_TIPO_ID, STR_IDENTIFICACION, STR_COD_EPS, DESC_EPS, STR_REGIMEN, STR_COD_ACTIVIDAD, NOMBRE_ACTIVIDAD, NUM_VALOR_TOTAL, NT_RULES, NT_DENOMINA, DESC_ACTIVIDAD
FROM (
  SELECT NUM_ANO, STR_TIPO_ID, STR_IDENTIFICACION, STR_COD_EPS, DESC_EPS, STR_REGIMEN, STR_COD_ACTIVIDAD,  NOMBRE_ACTIVIDAD, NUM_VALOR_TOTAL, NT_RULES, NT_DENOMINA, DESC_ACTIVIDAD, ROW_NUMBER() OVER (PARTITION BY STR_TIPO_ID, STR_IDENTIFICACION ORDER BY STR_TIPO_ID, STR_IDENTIFICACION) AS row_num
  FROM temp_suficiencia_unificado_dw
...
CREATE OR REPLACE TABLE tabla_muestra_dos_millon_suficiencia_2021
AS
SELECT
  TO_DATE(CAST(NUM_ANO AS STRING), 'yyyy') AS Year,
  STR_COD_EPS, 
  ...
  SUM(NUM_VALOR_TOTAL) AS Suma_total_valor,
  COUNT(NT_RULES) AS Frecuencia
FROM muestra_dos_millon_suficiencia_2021
GROUP BY TO_DATE(CAST(NUM_ANO AS STRING), 'yyyy'), STR_COD_EPS, 
  DESC_EPS, 
  STR_REGIMEN, 
  STR_COD_ACTIVIDAD,  
...
SELECT
  *
FROM
  tabla_muestra_dos_millon_suficiencia_2021

-- COMMAND ----------

-- muestra de 2.000.000 millones cédulas únicas año 2022
CREATE OR REPLACE TABLE muestra_dos_millon_suficiencia_2022 AS
SELECT DISTINCT NUM_ANO, STR_TIPO_ID, STR_IDENTIFICACION, STR_COD_EPS, DESC_EPS, STR_REGIMEN, STR_COD_ACTIVIDAD, NOMBRE_ACTIVIDAD, NUM_VALOR_TOTAL, NT_RULES, NT_DENOMINA, DESC_ACTIVIDAD
FROM (
  SELECT NUM_ANO, STR_TIPO_ID, STR_IDENTIFICACION, STR_COD_EPS, DESC_EPS, STR_REGIMEN, STR_COD_ACTIVIDAD,  NOMBRE_ACTIVIDAD, NUM_VALOR_TOTAL, NT_RULES, NT_DENOMINA, DESC_ACTIVIDAD, ROW_NUMBER() OVER (PARTITION BY STR_TIPO_ID, STR_IDENTIFICACION ORDER BY STR_TIPO_ID, STR_IDENTIFICACION) AS row_num
  FROM temp_suficiencia_unificado_dw
...
CREATE OR REPLACE TABLE tabla_muestra_dos_millon_suficiencia_2022
AS
SELECT
  TO_DATE(CAST(NUM_ANO AS STRING), 'yyyy') AS Year,
  STR_COD_EPS, 
  ...
  SUM(NUM_VALOR_TOTAL) AS Suma_total_valor,
  COUNT(NT_RULES) AS Frecuencia
FROM muestra_dos_millon_suficiencia_2022
GROUP BY TO_DATE(CAST(NUM_ANO AS STRING), 'yyyy'), STR_COD_EPS, 
  DESC_EPS, 
  STR_REGIMEN, 
  STR_COD_ACTIVIDAD,  
...
SELECT
  *
FROM
  tabla_muestra_dos_millon_suficiencia_2022

-- COMMAND ----------

-- Unir las tablas de la muestra dos millones años 2018_a_2022
CREATE OR REPLACE TABLE muestra_dos_millon_eps_sufici_contri_2018_a_2022 AS
SELECT * FROM tabla_muestra_dos_millon_suficiencia_2018
UNION 
SELECT * FROM tabla_muestra_dos_millon_suficiencia_2019
UNION 
SELECT * FROM tabla_muestra_dos_millon_suficiencia_2020
UNION 
SELECT * FROM tabla_muestra_dos_millon_suficiencia_2021
UNION 
SELECT * FROM tabla_muestra_dos_millon_suficiencia_2022;

-- Select data from the table
SELECT *
FROM muestra_dos_millon_eps_sufici_contri_2018_a_2022;
